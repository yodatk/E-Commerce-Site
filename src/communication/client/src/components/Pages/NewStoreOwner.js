...
export class NewStoreOwner extends Component {
    state = {
        username: "",
    ...
    onSubmit = (e) => {
        e.preventDefault();
        this.clearErrors();
        let new_errors = this.formUtils.validate_new_store_owner(this.state.username);
        this.setState({
                been_submitted: true,
                errors: new_errors
            },
                        ...
                        <MDBRow
                            ...
                            <MDBCol md="6">
                                <form className="needs-validation" onSubmit={this.onSubmit} noValidate>
                                    <p onChange={this.onChange} className="h3 text-center mb-4">Add new owner</p>
...
export default withRouter(NewStoreOwner);
