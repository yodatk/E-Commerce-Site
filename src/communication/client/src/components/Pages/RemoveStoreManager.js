...
export class RemoveStoreManager extends Component {
    state = {
        username: "",
                        ...
                        <MDBRow
                            ...
                            <MDBCol md="6">
                                <form className="needs-validation" onSubmit={this.onSubmit} noValidate>
                                    <p onChange={this.onChange} className="h3 text-center mb-4">Remove manager</p>
...
export default withRouter(RemoveStoreManager)